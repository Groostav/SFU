...
public class TrialSplashScreen979df69fab454112be894dbfadafdafb extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen979df69fab454112be894dbfadafdafb.this, sfu.android.SimpleActivity.class);
