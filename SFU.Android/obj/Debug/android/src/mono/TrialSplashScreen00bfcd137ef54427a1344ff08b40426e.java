...
public class TrialSplashScreen00bfcd137ef54427a1344ff08b40426e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen00bfcd137ef54427a1344ff08b40426e.this, sfu.android.SimpleActivity.class);
